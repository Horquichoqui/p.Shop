...
import { Bell, Link, Menu, Search, Settings, Sun, User } from "lucide-react";
  ...
  return (
    <div className={`flex justify-between items-center w-full mb-7`}>
      ...
      <div className="relative">
        <input
          type="search"
          placeholder="Digite o tipo de busca pelos grupos e produtos"
      ...
      <div className="flex justify-between items-center gap-5">
        ...
        <div className="flex items-center gap-3 cursor-pointer">
          ...
          <span className="font-semibold"> Gabriel Job</span>
        </div>
      </div>
      <Link href="/settings" />
